...
export type BlogCategory = "guide" | "decoration" | "pet";
...
export const blogContent: Localized<BlogListContent> = {
  tr: {
    ...
    posts: [
      { slug: "ozel-olcu-pleksi-kutu-siparis-rehberi", title: "Özel Ölçü Pleksi Kutu Sipariş Rehberi", date: "10 Mayıs 2026", image: "/assets/img/blog/thumb/ozel-olcu-pleksi-kutu.jpg", excerpt: null, hasDetail: false, category: "guide" },
      { slug: "pastane-ve-sekercilerde-pleksi-kutu-kullanimi", title: "Pastane ve Şekercilerde Pleksi Kutu Kullanımı", date: "9 Mayıs 2026", image: "/assets/img/blog/thumb/sekerleme-pastane-pleksi-kutu.jpg", excerpt: null, hasDetail: false, category: "decoration" },
      { slug: "pleksi-kutu-fiyatlarini-etkileyen-7-faktor", title: "Pleksi Kutu Fiyatlarını Etkileyen 7 Faktör", date: "9 Mayıs 2026", image: "/assets/img/blog/thumb/pleksi-kutu-price.jpg", excerpt: null, hasDetail: false, category: "guide" },
      { slug: "pleksi-kutu-nasil-uretilir", title: "Pleksi Kutu Nasıl Üretilir?", date: "9 Mayıs 2026", image: "/assets/img/blog/thumb/pleksi-kutu-nasil-uretilir.jpeg", excerpt: null, hasDetail: true, category: "guide" },
      { slug: "kopek-mama-kabi", title: "Köpek Mama Kabı", date: "25 Nisan 2026", image: "/assets/img/blog/thumb/pleksi-kopek-mama-kabi.jpeg", excerpt: "Köpek mama kabı seçerken paslanmaz çelik, seramik ve plastik farkları; yavaş yediren tasarımlar, kaydırmaz taban, doğru yükseklik ve temizlik ipuçları.", hasDetail: false, category: "pet" },
      { slug: "kedi-mama-kabi", title: "Kedi Mama Kabı", date: "25 Nisan 2026", image: "/assets/img/blog/thumb/pleksi-kedi-mama-kabi_1.jpeg", excerpt: "Kedi mama kabı seçerken malzeme (çelik/seramik/pleksi), bıyık konforu, kaymaz taban ve temizlik kriterlerini öğrenin.", hasDetail: false, category: "pet" },
      { slug: "pleksi-boru", title: "Pleksi Boru", date: "25 Nisan 2026", image: "/assets/img/blog/thumb/pleksi-boru.jpeg", excerpt: "Pleksi boru nedir, avantajları nelerdir? Kuruyemiş, market ve şarküteride pleksi boru ve borulardan oluşan pleksi silo çözümleri.", hasDetail: false, category: "guide" },
      { slug: "pleksi-bombe-akvaryum", title: "Pleksi Bombe Akvaryum", date: "25 Nisan 2026", image: "/assets/img/blog/thumb/pleksi-akvaryum.jpeg", excerpt: "Pleksi bombe akvaryum nedir? Optik şeffaflık, üretim detayları, mağaza/şarküteri kullanım senaryoları ve pleksi yüzey bakımı.", hasDetail: false, category: "guide" },
      { slug: "pleksi-bombe", title: "Pleksi Bombe", date: "25 Nisan 2026", image: "/assets/img/blog/thumb/8dae8629-a47d-403d-b994-c6243f3ce930.png", excerpt: "Pleksi bombe çözümlerle kuruyemiş, market ve şarküteri reyonlarında premium teşhir, hijyen ve düzen sağlayın.", hasDetail: false, category: "guide" },
      { slug: "kure-kutu", title: "Küre Kutu", date: "25 Nisan 2026", image: "/assets/img/blog/thumb/kure-kutu.jpg", excerpt: "Küre kutu ile jelibon ve şekerleme reyonunda 360° görünürlük, hijyenik sunum ve premium vitrin etkisi yakalayın.", hasDetail: false, category: "guide" },
      { slug: "bombe-kapak", title: "Bombe Kapak", date: "25 Nisan 2026", image: "/assets/img/blog/thumb/bombe-kapak_1.jpg", excerpt: "Bombe kapak nedir? Kuruyemiş dükkanında pleksi kutu ve ahşap kova sunumunu yükselten bombe kapak avantajları, ölçülendirme ve kullanım ipuçları.", hasDetail: false, category: "guide" },
      { slug: "toplu-gida-teshir-ekipmanlari", title: "Toplu Gıda Teşhir Ekipmanları", date: "28 Mart 2026", image: "/assets/img/blog/thumb/20260328_165213_c5abce562c34b0c1.png", excerpt: "Kuruyemiş, market ve şarküteri için pleksi kutu ve ahşap kova odaklı toplu gıda teşhir ekipmanları: hijyen, modülerlik, etiketleme ve satış artıran reyon kurgusu.", hasDetail: false, category: "decoration" },
      { slug: "parfum-dukkani-dekorasyonu", title: "Parfüm Dükkanı Dekorasyonu", date: "22 Mart 2026", image: "/assets/img/blog/thumb/20260322_183134_379ba035cb095ba1.png", excerpt: "Parfüm dükkanı dekorasyonu için vitrin, raf düzeni, aydınlatma ve tester alanı ipuçları. Pleksi kutu ve pleksi standlarla premium mağaza kurgusu.", hasDetail: false, category: "decoration" },
      { slug: "sarkuteri-dekorasyonu", title: "Şarküteri Dekorasyonu", date: "22 Mart 2026", image: "/assets/img/blog/thumb/20260322_180857_113272a9edf6e215.png", excerpt: "Şarküteri dekorasyonu için konsept, reyon yerleşimi, ışık ve etiketleme ipuçları. Pleksi kutu ve ahşap kova ile hijyenik, premium sunum.", hasDetail: false, category: "decoration" },
      { slug: "istocta-teshir-ekipmanlari-kuruyemis-ve-sarkuteri-icin-pleksi-kutu-ve-ahsap-kova-rehberi", title: "İstoç'ta Teşhir Ekipmanları: Kuruyemiş ve Şarküteri için Pleksi Kutu ve Ahşap Kova Rehberi", date: "15 Şubat 2026", image: "/assets/img/blog/thumb/20260215_230019_2c23c6fb8412aa7f.png", excerpt: "İstoç'ta kuruyemiş marketi ve şarküteri açacaklar için pleksi kutu ve ahşap kova odaklı profesyonel teşhir ekipmanları rehberi.", hasDetail: false, category: "decoration" },
    ],
  },
  en: {
    pageTitle: "Blog",
    ...
    posts: [
      { slug: "ozel-olcu-pleksi-kutu-siparis-rehberi", title: "Custom-Sized Plexiglass Box Order Guide", date: "May 10, 2026", image: "/assets/img/blog/thumb/ozel-olcu-pleksi-kutu.jpg", excerpt: null, hasDetail: false, category: "guide" },
      { slug: "pastane-ve-sekercilerde-pleksi-kutu-kullanimi", title: "Use of Plexiglass Boxes in Patisseries and Confectioneries", date: "May 9, 2026", image: "/assets/img/blog/thumb/sekerleme-pastane-pleksi-kutu.jpg", excerpt: null, hasDetail: false, category: "decoration" },
      { slug: "pleksi-kutu-fiyatlarini-etkileyen-7-faktor", title: "7 Factors Affecting Plexiglass Box Prices", date: "May 9, 2026", image: "/assets/img/blog/thumb/pleksi-kutu-price.jpg", excerpt: null, hasDetail: false, category: "guide" },
      { slug: "pleksi-kutu-nasil-uretilir", title: "How Are Plexiglass Boxes Manufactured", date: "May 9, 2026", image: "/assets/img/blog/thumb/pleksi-kutu-nasil-uretilir.jpeg", excerpt: null, hasDetail: true, category: "guide" },
      { slug: "kopek-mama-kabi", title: "Dog Food Bowl", date: "Apr 25, 2026", image: "/assets/img/blog/thumb/pleksi-kopek-mama-kabi.jpeg", excerpt: "Stainless steel, ceramic, and plastic differences when choosing a dog food bowl; slow-feed designs, non-slip base, correct height, and cleaning tips.", hasDetail: false, category: "pet" },
      { slug: "kedi-mama-kabi", title: "Cat Food Bowl", date: "Apr 25, 2026", image: "/assets/img/blog/thumb/pleksi-kedi-mama-kabi_1.jpeg", excerpt: "What to check when choosing a cat food bowl: material (steel/ceramic/plexi), whisker comfort, non-slip base, and cleaning criteria.", hasDetail: false, category: "pet" },
      { slug: "pleksi-boru", title: "Plexiglass Tube", date: "Apr 25, 2026", image: "/assets/img/blog/thumb/pleksi-boru.jpeg", excerpt: "What is a plexiglass tube and what are its advantages? Plexiglass tube and tube-based silo solutions for nut shops, markets, and delis.", hasDetail: false, category: "guide" },
      { slug: "pleksi-bombe-akvaryum", title: "Plexi Dome Aquarium", date: "Apr 25, 2026", image: "/assets/img/blog/thumb/pleksi-akvaryum.jpeg", excerpt: "What is a plexi dome aquarium? Optical clarity, manufacturing details, store/deli use cases, and plexiglass surface care.", hasDetail: false, category: "guide" },
      { slug: "pleksi-bombe", title: "Plexi Bombe", date: "Apr 25, 2026", image: "/assets/img/blog/thumb/8dae8629-a47d-403d-b994-c6243f3ce930.png", excerpt: "Achieve premium display, hygiene, and order in nut, market, and deli sections with plexi bombe solutions.", hasDetail: false, category: "guide" },
      { slug: "kure-kutu", title: "Sphere Box", date: "Apr 25, 2026", image: "/assets/img/blog/thumb/kure-kutu.jpg", excerpt: "Achieve 360° visibility, hygienic presentation, and a premium showcase effect in the candy section with the sphere box.", hasDetail: false, category: "guide" },
      { slug: "bombe-kapak", title: "Domed Lid", date: "Apr 25, 2026", image: "/assets/img/blog/thumb/bombe-kapak_1.jpg", excerpt: "What is a domed lid? Advantages, sizing, and usage tips for domed lids that elevate plexiglass box and wooden bucket presentation in nut shops.", hasDetail: false, category: "guide" },
      { slug: "toplu-gida-teshir-ekipmanlari", title: "Bulk Food Display Equipment", date: "Mar 28, 2026", image: "/assets/img/blog/thumb/20260328_165213_c5abce562c34b0c1.png", excerpt: "Plexiglass box and wooden bucket bulk food display equipment for nut shops, markets, and delis: hygiene, modularity, labeling, and sales-boosting layout.", hasDetail: false, category: "decoration" },
      { slug: "parfum-dukkani-dekorasyonu", title: "Perfume Shop Decoration", date: "Mar 22, 2026", image: "/assets/img/blog/thumb/20260322_183134_379ba035cb095ba1.png", excerpt: "Display, shelf layout, lighting, and tester-area tips for perfume shop decoration. A premium, hygienic store setup with plexiglass boxes and stands.", hasDetail: false, category: "decoration" },
      { slug: "sarkuteri-dekorasyonu", title: "Delicatessen Decoration", date: "Mar 22, 2026", image: "/assets/img/blog/thumb/20260322_180857_113272a9edf6e215.png", excerpt: "Concept, section layout, lighting, and labeling tips for delicatessen decoration. Hygienic, premium presentation with plexiglass boxes and wooden buckets.", hasDetail: false, category: "decoration" },
      { slug: "istocta-teshir-ekipmanlari-kuruyemis-ve-sarkuteri-icin-pleksi-kutu-ve-ahsap-kova-rehberi", title: "Display Equipment in İstoç: Plexiglass Bins and Wooden Barrels for Nuts & Delis", date: "Feb 15, 2026", image: "/assets/img/blog/thumb/20260215_230019_2c23c6fb8412aa7f.png", excerpt: "A professional display-equipment guide for those opening a nut shop or deli in İstoç, focused on plexiglass boxes and wooden buckets.", hasDetail: false, category: "decoration" },
    ],
  },
  de: {
    pageTitle: "Blog",
    ...
    posts: [
      { slug: "ozel-olcu-pleksi-kutu-siparis-rehberi", title: "Bestellratgeber für Plexiglas-Boxen nach Maß", date: "10. Mai 2026", image: "/assets/img/blog/thumb/ozel-olcu-pleksi-kutu.jpg", excerpt: null, hasDetail: false, category: "guide" },
      { slug: "pastane-ve-sekercilerde-pleksi-kutu-kullanimi", title: "Verwendung von Plexiglasboxen in Konditoreien und Süßwarengeschäften", date: "9. Mai 2026", image: "/assets/img/blog/thumb/sekerleme-pastane-pleksi-kutu.jpg", excerpt: null, hasDetail: false, category: "decoration" },
      { slug: "pleksi-kutu-fiyatlarini-etkileyen-7-faktor", title: "7 Faktoren, die die Preise von Plexiglasboxen beeinflussen", date: "9. Mai 2026", image: "/assets/img/blog/thumb/pleksi-kutu-price.jpg", excerpt: null, hasDetail: false, category: "guide" },
      { slug: "pleksi-kutu-nasil-uretilir", title: "Wie werden Plexiglasboxen hergestellt", date: "9. Mai 2026", image: "/assets/img/blog/thumb/pleksi-kutu-nasil-uretilir.jpeg", excerpt: null, hasDetail: true, category: "guide" },
      { slug: "kopek-mama-kabi", title: "Hundenapf", date: "25. Apr 2026", image: "/assets/img/blog/thumb/pleksi-kopek-mama-kabi.jpeg", excerpt: "Unterschiede zwischen Edelstahl, Keramik und Kunststoff bei der Wahl eines Hundenapfs; langsam fütternde Designs, rutschfester Boden, richtige Höhe und Reinigungstipps.", hasDetail: false, category: "pet" },
      { slug: "kedi-mama-kabi", title: "Katzennapf", date: "25. Apr 2026", image: "/assets/img/blog/thumb/pleksi-kedi-mama-kabi_1.jpeg", excerpt: "Worauf bei der Wahl eines Katzennapfs zu achten ist: Material (Stahl/Keramik/Plexiglas), Schnurrhaarkomfort, rutschfester Boden und Reinigungskriterien.", hasDetail: false, category: "pet" },
      { slug: "pleksi-boru", title: "Plexiglasrohr", date: "25. Apr 2026", image: "/assets/img/blog/thumb/pleksi-boru.jpeg", excerpt: "Was ist ein Plexiglasrohr und welche Vorteile hat es? Rohrbasierte Silo-Lösungen für Nussgeschäfte, Märkte und Feinkostläden.", hasDetail: false, category: "guide" },
      { slug: "pleksi-bombe-akvaryum", title: "Plexi-Kuppel-Aquarium", date: "25. Apr 2026", image: "/assets/img/blog/thumb/pleksi-akvaryum.jpeg", excerpt: "Was ist ein Plexi-Kuppel-Aquarium? Optische Klarheit, Herstellungsdetails, Anwendungsfälle für Geschäfte/Feinkostläden und Pflege der Plexiglasoberfläche.", hasDetail: false, category: "guide" },
      { slug: "pleksi-bombe", title: "Plexi Bombe", date: "25. Apr 2026", image: "/assets/img/blog/thumb/8dae8629-a47d-403d-b994-c6243f3ce930.png", excerpt: "Erzielen Sie mit Plexi-Bombe-Lösungen eine hochwertige Präsentation, Hygiene und Ordnung in Nuss-, Markt- und Feinkostabteilungen.", hasDetail: false, category: "guide" },
      { slug: "kure-kutu", title: "Kugelbox", date: "25. Apr 2026", image: "/assets/img/blog/thumb/kure-kutu.jpg", excerpt: "Erzielen Sie mit der Kugelbox 360°-Sichtbarkeit, hygienische Präsentation und einen hochwertigen Vitrineneffekt in der Süßwarenabteilung.", hasDetail: false, category: "guide" },
      { slug: "bombe-kapak", title: "Gewölbter Deckel", date: "25. Apr 2026", image: "/assets/img/blog/thumb/bombe-kapak_1.jpg", excerpt: "Was ist ein gewölbter Deckel? Vorteile, Maße und Anwendungstipps für gewölbte Deckel, die die Präsentation von Plexiglasboxen aufwerten.", hasDetail: false, category: "guide" },
      { slug: "toplu-gida-teshir-ekipmanlari", title: "Lebensmittel-Präsentationsausstattung für Großgebinde", date: "28. März 2026", image: "/assets/img/blog/thumb/20260328_165213_c5abce562c34b0c1.png", excerpt: "Plexiglasbox- und Holzeimer-basierte Präsentationsausstattung für Nussgeschäfte, Märkte und Feinkostläden: Hygiene, Modularität, Etikettierung und verkaufsförderndes Layout.", hasDetail: false, category: "decoration" },
      { slug: "parfum-dukkani-dekorasyonu", title: "Parfümerie-Dekoration", date: "22. März 2026", image: "/assets/img/blog/thumb/20260322_183134_379ba035cb095ba1.png", excerpt: "Vitrinen-, Regallayout-, Beleuchtungs- und Testbereich-Tipps. Ein hochwertiger, hygienischer Ladenaufbau mit Plexiglasboxen und -ständern.", hasDetail: false, category: "decoration" },
      { slug: "sarkuteri-dekorasyonu", title: "Feinkost-Dekoration", date: "22. März 2026", image: "/assets/img/blog/thumb/20260322_180857_113272a9edf6e215.png", excerpt: "Konzept, Abteilungslayout, Beleuchtung und Etikettierungstipps. Hygienische, hochwertige Präsentation mit Plexiglasboxen und Holzeimern.", hasDetail: false, category: "decoration" },
      { slug: "istocta-teshir-ekipmanlari-kuruyemis-ve-sarkuteri-icin-pleksi-kutu-ve-ahsap-kova-rehberi", title: "Präsentationsausstattung in İstoç: Plexiglasbehälter und Holzfässer für Nüsse & Feinkost", date: "15. Februar 2026", image: "/assets/img/blog/thumb/20260215_230019_2c23c6fb8412aa7f.png", excerpt: "Ein professioneller Ratgeber für alle, die in İstoç ein Nussgeschäft oder einen Feinkostladen eröffnen, mit Fokus auf Plexiglasboxen und Holzeimer.", hasDetail: false, category: "decoration" },
    ],
  },
  ar: {
    pageTitle: "المدونة",
    ...
    posts: [
      { slug: "ozel-olcu-pleksi-kutu-siparis-rehberi", title: "دليل طلب صندوق بليكسي بمقاس مخصص", date: "10 مايو 2026", image: "/assets/img/blog/thumb/ozel-olcu-pleksi-kutu.jpg", excerpt: null, hasDetail: false, category: "guide" },
      { slug: "pastane-ve-sekercilerde-pleksi-kutu-kullanimi", title: "استخدام صناديق بليكسي في المخابز والحلويات", date: "9 مايو 2026", image: "/assets/img/blog/thumb/sekerleme-pastane-pleksi-kutu.jpg", excerpt: null, hasDetail: false, category: "decoration" },
      { slug: "pleksi-kutu-fiyatlarini-etkileyen-7-faktor", title: "7 عوامل تؤثر على أسعار صناديق بليكسي", date: "9 مايو 2026", image: "/assets/img/blog/thumb/pleksi-kutu-price.jpg", excerpt: null, hasDetail: false, category: "guide" },
      { slug: "pleksi-kutu-nasil-uretilir", title: "كيف تُصنع صناديق بليكسي؟", date: "9 مايو 2026", image: "/assets/img/blog/thumb/pleksi-kutu-nasil-uretilir.jpeg", excerpt: null, hasDetail: true, category: "guide" },
      { slug: "kopek-mama-kabi", title: "وعاء طعام الكلاب", date: "25 أبريل 2026", image: "/assets/img/blog/thumb/pleksi-kopek-mama-kabi.jpeg", excerpt: "عند اختيار وعاء طعام الكلاب: الفروق بين الفولاذ المقاوم للصدأ والسيراميك والبلاستيك؛ تصاميم التغذية البطيئة، القاعدة المانعة للانزلاق، الارتفاع الصحيح ونصائح التنظيف.", hasDetail: false, category: "pet" },
      { slug: "kedi-mama-kabi", title: "وعاء طعام القطط", date: "25 أبريل 2026", image: "/assets/img/blog/thumb/pleksi-kedi-mama-kabi_1.jpeg", excerpt: "ما يجب مراعاته عند اختيار وعاء طعام القطط: المادة (فولاذ/سيراميك/بليكسي)، راحة الشوارب، القاعدة المانعة للانزلاق ومعايير التنظيف.", hasDetail: false, category: "pet" },
      { slug: "pleksi-boru", title: "أنبوب بليكسي", date: "25 أبريل 2026", image: "/assets/img/blog/thumb/pleksi-boru.jpeg", excerpt: "ما هو أنبوب بليكسي وما فوائده؟ حلول أنبوب وسيلو بليكسي لمحلات المكسرات والأسواق ومحلات الأطعمة الجاهزة.", hasDetail: false, category: "guide" },
      { slug: "pleksi-bombe-akvaryum", title: "حوض سمك بليكسي قبة", date: "25 أبريل 2026", image: "/assets/img/blog/thumb/pleksi-akvaryum.jpeg", excerpt: "ما هو حوض السمك البليكسي القبة؟ الشفافية البصرية، تفاصيل التصنيع، حالات الاستخدام في المتاجر، والعناية بسطح البليكسي.", hasDetail: false, category: "guide" },
      { slug: "pleksi-bombe", title: "بليكسي بومبيه", date: "25 أبريل 2026", image: "/assets/img/blog/thumb/8dae8629-a47d-403d-b994-c6243f3ce930.png", excerpt: "احصل على عرض متميز ونظافة وترتيب في أقسام المكسرات والأسواق والأطعمة الجاهزة مع حلول بليكسي بومبيه.", hasDetail: false, category: "guide" },
      { slug: "kure-kutu", title: "صندوق كروي", date: "25 أبريل 2026", image: "/assets/img/blog/thumb/kure-kutu.jpg", excerpt: "احصل على رؤية 360 درجة وعرض صحي وتأثير فاخر في قسم الحلويات مع الصندوق الكروي.", hasDetail: false, category: "guide" },
      { slug: "bombe-kapak", title: "غطاء مقبب", date: "25 أبريل 2026", image: "/assets/img/blog/thumb/bombe-kapak_1.jpg", excerpt: "ما هو الغطاء المقبب؟ الفوائد والمقاسات ونصائح الاستخدام للأغطية المقببة التي ترفع مستوى عرض صناديق البليكسي في محلات المكسرات.", hasDetail: false, category: "guide" },
      { slug: "toplu-gida-teshir-ekipmanlari", title: "معدات عرض الأغذية بالجملة", date: "28 مارس 2026", image: "/assets/img/blog/thumb/20260328_165213_c5abce562c34b0c1.png", excerpt: "معدات عرض أغذية بالجملة قائمة على صناديق البليكسي والبراميل الخشبية لمحلات المكسرات والأسواق: النظافة، القابلية للتجميع، وضع الملصقات، وتخطيط يعزز المبيعات.", hasDetail: false, category: "decoration" },
      { slug: "parfum-dukkani-dekorasyonu", title: "ديكور محل العطور", date: "22 مارس 2026", image: "/assets/img/blog/thumb/20260322_183134_379ba035cb095ba1.png", excerpt: "نصائح الواجهات وتخطيط الرفوف والإضاءة ومنطقة الاختبار. تجهيز متجر فاخر وصحي بصناديق ومنصات بليكسي.", hasDetail: false, category: "decoration" },
      { slug: "sarkuteri-dekorasyonu", title: "ديكور محل الأطعمة الجاهزة", date: "22 مارس 2026", image: "/assets/img/blog/thumb/20260322_180857_113272a9edf6e215.png", excerpt: "المفهوم وتخطيط الأقسام والإضاءة ونصائح وضع الملصقات. عرض صحي وفاخر بصناديق البليكسي والبراميل الخشبية.", hasDetail: false, category: "decoration" },
      { slug: "istocta-teshir-ekipmanlari-kuruyemis-ve-sarkuteri-icin-pleksi-kutu-ve-ahsap-kova-rehberi", title: "معدات العرض في إستوچ: صناديق بليكسي وبراميل خشبية للمكسرات والأطعمة الجاهزة", date: "15 فبراير 2026", image: "/assets/img/blog/thumb/20260215_230019_2c23c6fb8412aa7f.png", excerpt: "دليل احترافي لمعدات العرض لمن يفتتحون محل مكسرات أو أطعمة جاهزة في إستوچ، يركز على صناديق البليكسي والبراميل الخشبية.", hasDetail: false, category: "decoration" },
    ],
  },
};
