...
export const contactContent: Localized<ContactContent> = {
  tr: {
    ...
    recaptchaText: "Bu form reCAPTCHA ile korunmaktadır.",
    submitLabel: "Gönder",
    successTitle: "Mesajınız Alındı",
    successBody: "Bizimle iletişime geçtiğiniz için teşekkür ederiz. Ekibimiz mesajınızı inceleyecektir.",
  ...
  en: {
    ...
    recaptchaText: "This form is protected by reCAPTCHA.",
    submitLabel: "Submit",
    successTitle: "Message Received",
    successBody: "Thank you for reaching out. Our team will review your message.",
  ...
  de: {
    ...
    recaptchaText: "Dieses Formular ist durch reCAPTCHA geschützt.",
    submitLabel: "Senden",
    successTitle: "Nachricht erhalten",
    successBody: "Vielen Dank für Ihre Kontaktaufnahme. Unser Team wird Ihre Nachricht prüfen.",
  ...
  ar: {
    ...
    recaptchaText: "هذا النموذج محمي بواسطة reCAPTCHA.",
    submitLabel: "أرسل",
    successTitle: "تم استلام رسالتكم",
    successBody: "نشكركم على تواصلكم معنا. سيقوم فريقنا بمراجعة رسالتكم.",
